...
{  
    public class PaginatedResult<T>
    {
        ...
        internal PaginatedResult(bool succeeded, List<T> data , List<string> messages, int count = 0, int page = 1, int pageSize = 10, HttpStatusCode statusCode = HttpStatusCode.OK)
        {
            Data = data;
            CurrentPage = page;
            Succeeded = succeeded;
